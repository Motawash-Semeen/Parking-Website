...
<body>
                            ...
                            <li class="header-notification">
                                <div class="dropdown-primary dropdown">
                                    ...
                                    <ul class="show-notification notification-view dropdown-menu"
                                        ...
                                        <li>
                                            <div class="media">
                                                <img class="img-radius" src="{{ asset('backend') }}/jpg/avatar-4.jpg"
                                        ...
                                        <li>
                                            <div class="media">
                                                <img class="img-radius" src="{{ asset('backend') }}/jpg/avatar-3.jpg"
                                                    alt="Generic placeholder image">
                                                <div class="media-body">
                            ...
                            <div class="main-friend-list">
                                <div class="media userlist-box waves-effect waves-light" data-id="1"
                                    ...
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius img-radius" src="{{ asset('backend') }}/jpg/avatar-3.jpg"
                                            alt="Generic placeholder image ">
                                ...
                                <div class="media userlist-box waves-effect waves-light" data-id="2"
                                    ...
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius" src="{{ asset('backend') }}/jpg/avatar-2.jpg"
                                            alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
                                ...
                                <div class="media userlist-box waves-effect waves-light" data-id="3"
                                    ...
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius" src="{{ asset('backend') }}/jpg/avatar-4.jpg"
                                            alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
                                ...
                                <div class="media userlist-box waves-effect waves-light" data-id="4"
                                    ...
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius" src="{{ asset('backend') }}/jpg/avatar-3.jpg"
                                            alt="Generic placeholder image">
                ...
                <div class="main-friend-chat">
                    <div class="media chat-messages">
                        <a class="media-left photo-table" href="#!">
                            <img class="media-object img-radius img-radius m-t-5" src="{{ asset('backend') }}/jpg/avatar-2.jpg"
                                alt="Generic placeholder image">
                        </a>
                                                        ...
                                                        <div class="latest-update-box">
                                                            <div class="row p-t-20 p-b-30">
                                                                <div class="col-auto text-right update-meta p-r-0">
                                                                    <img src="{{ asset('backend') }}/jpg/avatar-4.jpg" alt="user image"
                                                ...
                                                <div class="card new-cust-card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="align-middle m-b-35">
                                                            <img src="{{ asset('backend') }}/jpg/avatar-2.jpg" alt="user image"
                                                        ...
                                                        <div class="align-middle m-b-35">
                                                            <img src="{{ asset('backend') }}/jpg/avatar-3.jpg" alt="user image"
                                                                class="img-radius img-40 align-top m-r-15">
                                                            <div class="d-inline-block">
                                                                <a href="#!">
                                                                    <h6>John Doue</h6>
                                                        ...
                                                        <div class="latest-update-box">
                                                            <div class="row p-t-20 p-b-30">
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <img src="{{ asset('backend') }}/jpg/01.jpg" alt=""
                                                                        class="img-fluid img-100 m-r-15 m-b-10">
                                                                    <img src="{{ asset('backend') }}/jpg/03.jpg" alt=""
                                                                        class="img-fluid img-100 m-r-15 m-b-10">
                                                                </div>
                                                            </div>
                                                            <div class="row p-b-30">
  ...
  gtag('config', 'UA-23581568-13');
    ...
    <script src="{{ asset('backend') }}/js/rocket-loader.min.js" data-cf-settings="d2d1d6e2f87cbebdf4013b26-|49" defer="">
    </script>
</body>
